...
class AMD:
    #Daten vorbereiten
    df = get_data("AMD", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/AMD", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
...
ai_amd = AMD()
print("Reale Werte: ", ai_amd.returnRealVal())
print("Predictedete Werte: ", ai_amd.returnPredictedVal())
print("Future Werte: ", ai_amd.returnFutureVal())
print("Date1: ", ai_amd.returnDate1())
print("Date2: ", ai_amd.returnDate2())