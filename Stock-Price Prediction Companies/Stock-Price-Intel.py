...
class Intel:
    #Daten vorbereiten
    df = get_data("intc", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/INTC", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
...
ai_intel = Intel()
print("Reale Werte: ", ai_intel.returnRealVal())
print("Predictedete Werte: ", ai_intel.returnPredictedVal())
print("Future Werte: ", ai_intel.returnFutureVal())
print("Date1: ", ai_intel.returnDate1())
print("Date2: ", ai_intel.returnDate2())