...
class AA:
    #Daten vorbereiten
    df = get_data("aal", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/AAL", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
    ...
    plt.title("American Airlines-Kursverlauf")
    plt.legend()
    plt.show()
...
ai_aa = AA()
print("Reale Werte: ", ai_aa.returnRealVal())
print("Predictedete Werte: ", ai_aa.returnPredictedVal())
print("Future Werte: ", ai_aa.returnFutureVal())
print("Date1: ", ai_aa.returnDate1())
print("Date2: ", ai_aa.returnDate2())