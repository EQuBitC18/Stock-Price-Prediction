...
class Blizzard:
    #Daten vorbereiten
    df = get_data("ATVI", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/ATVI", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
    ...
    plt.title("Blizzard-Kursverlauf")
    plt.legend()
    plt.show()
...
ai_blizzard = Blizzard()
print("Reale Werte: ", ai_blizzard.returnRealVal())
print("Predictedete Werte: ", ai_blizzard.returnPredictedVal())
print("Future Werte: ", ai_blizzard.returnFutureVal())
print("Date1: ", ai_blizzard.returnDate1())
print("Date2: ", ai_blizzard.returnDate2())