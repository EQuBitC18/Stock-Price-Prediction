...
class Ebay:
    #Daten vorbereiten
    df = get_data("EBAY", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/EBAY", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
...
ai_ebay = Ebay()
print("Reale Werte: ", ai_ebay.returnRealVal())
print("Predictedete Werte: ", ai_ebay.returnPredictedVal())
print("Future Werte: ", ai_ebay.returnFutureVal())
print("Date1: ", ai_ebay.returnDate1())
print("Date2: ", ai_ebay.returnDate2())