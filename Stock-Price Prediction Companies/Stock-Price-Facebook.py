...
class Facebook:
    #Daten vorbereiten
    df = get_data("fb", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/FB", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
    ...
    plt.title("Facebook-Kursverlauf")
    plt.legend()
    plt.show()
...
ai_facebook = Facebook()
print("Reale Werte: ", ai_facebook.returnRealVal())
print("Predictedete Werte: ", ai_facebook.returnPredictedVal())
print("Future Werte: ", ai_facebook.returnFutureVal())
print("Date1: ", ai_facebook.returnDate1())
print("Date2: ", ai_facebook.returnDate2())