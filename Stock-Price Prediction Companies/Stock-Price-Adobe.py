...
class Adobe:
    #Daten vorbereiten
    df = get_data("adbe", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/ADBE", api_key="uwhDmpJXeXBPmmzRHaYD", start_date="01/01/2009", end_date="02/01/2018")
    forecast_out = 50 #Tage, für die gepredicted werden sollen
...
ai_adobe = Adobe()
print("Reale Werte: ", ai_adobe.returnRealVal())
print("Predictedete Werte: ", ai_adobe.returnPredictedVal())
print("Future Werte: ", ai_adobe.returnFutureVal())
print("Date1: ", ai_adobe.returnDate1())
print("Date2: ", ai_adobe.returnDate2())