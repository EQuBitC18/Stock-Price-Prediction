...
class Cisco:
    #Daten vorbereiten
    df = get_data("CSCO", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/CSCO", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
...
ai_cisco = Cisco()
print("Reale Werte: ", ai_cisco.returnRealVal())
print("Predictedete Werte: ", ai_cisco.returnPredictedVal())
print("Future Werte: ", ai_cisco.returnFutureVal())
print("Date1: ", ai_cisco.returnDate1())
print("Date2: ", ai_cisco.returnDate2())