...
class Microsoft:
    #Daten vorbereiten
    df = get_data("msft", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/MSFT", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
    ...
    plt.title("Microsoft-Kursverlauf")
    plt.legend()
    plt.show()
...
ai_microsoft = Microsoft()
print("Reale Werte: ", ai_microsoft.returnRealVal())
print("Predictedete Werte: ", ai_microsoft.returnPredictedVal())
print("Future Werte: ", ai_microsoft.returnFutureVal())
print("Date1: ", ai_microsoft.returnDate1())
print("Date2: ", ai_microsoft.returnDate2())