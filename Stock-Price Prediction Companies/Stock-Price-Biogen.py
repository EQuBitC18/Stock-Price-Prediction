...
class Biogen:
    #Daten vorbereiten
    df = get_data("biib", start_date="01/02/2009", end_date="12/29/2017", index_as_date=False, interval="1d")
    ...
    # Future prediction
    # Daten vorbereiten
    df2 = quandl.get("WIKI/BIIB", start_date="01/01/2009", end_date="01/01/2018", api_key="uwhDmpJXeXBPmmzRHaYD")
...
ai_biogen = Biogen()
print("Reale Werte: ", ai_biogen.returnRealVal())
print("Predictedete Werte: ", ai_biogen.returnPredictedVal())
print("Future Werte: ", ai_biogen.returnFutureVal())
print("Date1: ", ai_biogen.returnDate1())
print("Date2: ", ai_biogen.returnDate2())